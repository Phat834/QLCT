...
export default function Dashboard() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold light:text-gray-800 dark:text-white mb-6">Dashboard</h2>
      ...
      <h3 className="text-lg font-semibold light:text-gray-700 dark:text-gray-300 mb-4">Giao dịch gần đây</h3>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {transactions.length === 0 ? (
              <tr>
                <td colSpan={5} className="px-4 py-8 text-center light:text-gray-400 dark:text-gray-500">Chưa có giao dịch</td>
              </tr>
            ) : (
