...
export const createApiRouter = () => {
    ...
    const apiController = new ApiController(new GetTransactionsUseCase(transactionRepo), new GetWalletsUseCase(walletRepo), new GetCategoriesUseCase(categoryRepo), new GetBudgetsUseCase(budgetRepo), new GetBudgetByCategoryUseCase(budgetRepo), new CreateCategoryUseCase(categoryRepo), new UpdateCategoryUseCase(categoryRepo), new DeleteCategoryUseCase(categoryRepo), new CreateBudgetUseCase(budgetRepo), new UpdateBudgetUseCase(budgetRepo), new DeleteBudgetUseCase(budgetRepo));
